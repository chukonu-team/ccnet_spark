...
$SPARK_PATH/bin/spark-submit \
    ...
    --conf spark.kubernetes.driver.volumes.hostPath.spark-local-dir-0.options.path=$LOCAL_DIR_0_PATH \
    --conf spark.kubernetes.driver.volumes.hostPath.spark-local-dir-0.mount.subPath=$LOCAL_DIR_0_SUB_PATH \
    --conf spark.kubernetes.driver.volumes.hostPath.spark-local-dir-0.mount.path=$LOCAL_DIR_0_MOUNT_PATH \
    --conf spark.kubernetes.executor.volumes.hostPath.spark-local-dir-0.options.path=$LOCAL_DIR_0_PATH \
    --conf spark.kubernetes.executor.volumes.hostPath.spark-local-dir-0.mount.subPath=$LOCAL_DIR_0_SUB_PATH \
    --conf spark.kubernetes.executor.volumes.hostPath.spark-local-dir-0.mount.path=$LOCAL_DIR_0_MOUNT_PATH \
